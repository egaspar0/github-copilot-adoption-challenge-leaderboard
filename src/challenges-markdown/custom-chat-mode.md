...
- **Step 2.** Add a file `ci-cd-release-manager.agent.md` with agent instructions, limiting scope to CI/CD YAML edits, semantic versioning, and changelog automation. Refer to the [Custom agents documentation](https://code.visualstudio.com/docs/copilot/customization/custom-agents) for guidance on structuring the agent file.
